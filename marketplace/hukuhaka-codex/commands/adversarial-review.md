...
- `/hukuhaka-codex:adversarial-review` uses the same review target selection as `/hukuhaka-codex:review`.
- It supports working-tree review, branch review, and `--base <ref>`.
- It does not support `--scope staged` or `--scope unstaged`.
- Unlike `/hukuhaka-codex:review`, it can still take extra focus text after the flags.
...
- After launching the command, tell the user: "Codex adversarial review started in the background. Check `/hukuhaka-codex:status` for progress."
